...
export const payment = <ThrowOnError extends boolean = false>(options: Options<PaymentData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PaymentResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const subscriptionStatus = <ThrowOnError extends boolean = false>(options: Options<SubscriptionStatusData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SubscriptionStatusResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
